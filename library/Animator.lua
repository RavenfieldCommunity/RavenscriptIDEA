...
---@see http://ravenfieldgame.com/ravenscript/api/Animator.html
...
Animator = {
    ...
    CrossFade = function (stateName, normalizedTransitionDuration, layer, normalizedTimeOffset, normalizedTransitionTime) end,
    ---@param stateHashName string
    ---@param fixedTransitionDuration float
    ---@param layer int?
    ---@param fixedTimeOffset? float
    ---@param normalizedTransitionTime? float
    CrossFadeInFixedTime  = function (stateHashName, fixedTransitionDuration, layer, fixedTimeOffset, fixedTransitionTime, normalizedTransitionTime) end,
