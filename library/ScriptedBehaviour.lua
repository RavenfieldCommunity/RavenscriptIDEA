...
ScriptedBehaviour = {
	...
	---@param coroutine DynValue A closure; or the name of a member function as a string. A closure is executed without arguments while self is automatically passed to member functions.
